...
function About() {
    return (
        <section id="about" className="max-h-full ">
            ...
            <div className="md:grid md:grid-cols-2 space-x-2  gap-2 md:space-x-24 md:max-w-full md:mx-24">
                {/* images left side */}
                ...
                <div className="flex justify-center space-x-2 mb-8 md:mb-0">
                    ...
                    <div>
                        <Image
                            className="w-auto md:mt-28 md:w-64 md:h-96 mt-14"
                            src={About2}
                            alt="about1"
                            width={200}
                            height={200}
                ...
                <div className="">
                    <span className="text-pink-700 text-xs mt-28  md:mt-0 leading-relaxed 
                    md:tracking-widest uppercase ">
                        Brand new app to blow your mind
                    </span>
                    <h2 className="my-6 text-2xl md:text-4xl font-bold leading-tight md:mr-28 ">
                        We’ve made a life
                    ...
                    <p className="text-gray-400 max-w-full">Lorem ipsum dolor sit amet, 
                    ...
                    <Buttons text="Get Started Now" colorType={'primary'} />
                </div>
            </div>
        </section>
    )
