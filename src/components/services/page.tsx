    ...
    return (
        <div id="services" className="py-24">
            ...
            <div className=" flex flex-wrap justify-center text-center gap-8 gap-y-8 ">
                ...
                <div className="w-80 max-h-[29rem] justify-around hover:shadow-2xl ml-4 md:ml-0">
                    <div>
                        <Image
                            className="w-80 h-52"
                            src={image1}
                    ...
                    <div className="pt-8 md:pt-12 px-4">
                        ...
                        <p className="text-gray-400 md:my-12 my-4 text-xs md:text-lg ">
                ...
                <div className="w-80 max-h-[29rem] justify-around hover:shadow-2xl ml-4 md:ml-0">
                    ...
                    <div className="pt-8 md:pt-12 px-4">
                        <span className="font-bold text text-xlpt-8 md:pt-12 px-4 tracking-wider">Personol Trainings</span>
                        <p className="text-gray-400 md:my-12 my-4 text-xs md:text-lg ">
