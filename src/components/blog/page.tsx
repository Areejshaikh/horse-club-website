...
function Blog() {
    return (
        <section id="blog" className="my-24 max-w-full overflow-hidden">
            ...
            <h3 className="text-gray-900 flex justify-center mx-4 md:mx-0 text-xl md:text-4xl font-semibold pt-8">
